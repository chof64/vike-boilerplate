Generated with [vike.dev/new](https://vike.dev/new) ([version 595](https://www.npmjs.com/package/create-vike/v/0.0.595)) using this command:

```sh
pnpm create vike@latest --react --tailwindcss --biome
```
